...
#[carbon(discriminator = "0xc2ab1c46684d5b2f")]
...
pub struct BuyExactQuoteInV2InstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for BuyExactQuoteInV2 {
    type ArrangedAccounts = BuyExactQuoteInV2InstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(BuyExactQuoteInV2InstructionAccounts {
            global,
            base_mint,
            quote_mint,
            base_token_program,
